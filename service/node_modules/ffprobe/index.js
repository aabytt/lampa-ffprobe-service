...
function getInfo(filePath, opts, cb) {
  ...
  params.push('-v', 'quiet', '-print_format', 'json', '-show_entries', 'stream=index,codec_type,codec_name,codec_long_name,codec_time_base,sample_rate,channels,channel_layout,bit_rate:stream_tags=title,handler_name,language', filePath );
  var d = Deferred();
  var info;
  var stderr;
